    ...
    <div class="site-blocks-cover inner-page-cover overlay"
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10">
                    <h1 class="mb-2"> Props By Desc Properties
                    </h1>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="site-section-title mb-5">
                        <h2>Props By Desc Properties</h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="property-entry h-100">
                            <a href="{{ route('single.prop', $propByDesc->id) }}" class="property-thumbnail">
                                ...
                                <img src="{{ asset('assets/images/' . $propByDesc->image . '') }}" alt="Image"
                                    class="img-fluid">
                            </a>
                            <div class="p-4 property-body">
                                <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                                <h2 class="property-title"><a
                                        href="{{ route('single.prop', $propByDesc->id) }}">{{ $propByDesc->title }}</a>
                                </h2>
                                <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span>
                                    {{ $propByDesc->location }}</span>
                                <strong
                                    class="property-price text-primary mb-3 d-block text-success">${{ $propByDesc->price }}</strong>
                                <ul class="property-specs-wrap mb-3 mb-lg-0">
                                    <li>
                                        <span class="property-specs">Beds</span>
                                        <span class="property-specs-number">{{ $propByDesc->beds }}<sup>+</sup></span>
